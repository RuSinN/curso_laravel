...
<a class="btn btn-success btn-sm mb-3" href="{{ route('post.create') }}">Nuevo Post</a>
    ...
    <tbody>
        @foreach ($posts as $post)
            <tr>
                ...
                <td>
                    <a class="btn btn-xs btn-primary" href="{{ route('post.show', $post->id) }}"> Ver </a>
                    <a class="btn btn-xs btn-primary" href="{{ route('post.edit', $post->id) }}"> Editar </a>
